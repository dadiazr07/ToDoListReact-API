			...
			<div className="container w-75 d-flex justify-content-center py-5">
				<div className="container row w-50 bg-light rounded-3">
					...
					<ul className="list-group list-group-flush list-unstyled p-0 mb-0 bg-light">
						...
						{list.map((task, index) => {
							return (<div className="list-group-item d-flex justify-content-start row bg-light" key={index}>
										{isHovering == true ? 
										<><li onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} className="col-11 bg-light"><strong className="text-capitalize text-secondary">{task}</strong></li>
